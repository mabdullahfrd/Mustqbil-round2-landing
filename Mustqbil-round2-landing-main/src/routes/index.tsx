...
function Index() {
  ...
  const translateX = (mousePos.x - 0.5) * -50;
  const translateY = (mousePos.y - 0.5) * -50;

  return (
    <div className="flex min-h-screen flex-col bg-background relative">
      {/* Background Video with cursor-follow parallax */}
      <video
        className="video-bg"
      ...
      />
      <div className="fixed inset-0 z-0 bg-gradient-to-br from-black/60 via-black/40 to-black/70" />

      <header className="fixed top-0 left-0 right-0 z-10 px-5 sm:px-8 py-4 sm:py-5 glass-dark border-b border-white/10">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a
              href="#"
              className="text-[23px] underline underline-offset-2 hover:opacity-60 transition-opacity text-white"
            >
              Start free trial
        ...
        {mobileMenuOpen && (
          <div className="md:hidden fixed inset-0 z-9 glass-dark flex flex-col items-start justify-center px-8 gap-8 pt-20">
            <nav className="flex flex-col gap-4 text-left">
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-[32px] font-medium text-white hover:opacity-60 transition-opacity">
                Features
              </a>
              <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-[32px] font-medium text-white hover:opacity-60 transition-opacity">
                How it works
              </a>
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-[32px] font-medium text-white hover:opacity-60 transition-opacity">
                Pricing
              </a>
              <a href="#faq" onClick={() => setMobileMenuOpen(false)} className="text-[32px] font-medium text-white hover:opacity-60 transition-opacity">
                FAQ
              </a>
              <hr className="w-full border-white/20" />
              <a href="#" className="text-[32px] font-medium text-white hover:opacity-60 transition-opacity">
                Log in
              </a>
      ...
      <main className="flex-1 relative z-10">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <AnimateOnScroll>
              <div className="mb-14 max-w-2xl">
                <h2 className="font-heading font-semibold tracking-tight text-white sm:text-4xl text-3xl">
              ...
              {[
                ...
                <AnimateOnScroll key={step.step} delay={i * 0.15}>
                  <div className="glass-card h-full rounded-xl p-6">
                    <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-white/20 text-sm font-bold text-white">
                      {step.step}
                    </span>
            ...
            <div className="grid items-start gap-6 md:grid-cols-3">
              <AnimateOnScroll delay={0}>
                <div className="glass-card h-full flex flex-col rounded-2xl p-6">
                  ...
                  <Button variant="outline" className="mt-8 w-full border-white/30 text-white hover:bg-white hover:text-black">
                    Get started free
                  </Button>
                </div>
              </AnimateOnScroll>
              <AnimateOnScroll delay={0.1}>
                <div className="glass-card h-full flex flex-col rounded-2xl p-6 border-2 border-white/40 shadow-xl">
                  <div className="rounded-t-[calc(var(--radius)-1px)] bg-white/90 px-4 py-1.5 text-center text-xs font-semibold text-black mb-4">
                    Most popular
                  </div>
                  ...
                  <Button className="mt-8 w-full bg-white text-black hover:bg-white/80">
                    Start free trial
        ...
        <section id="faq" className="relative py-20 sm:py-24 lg:py-28">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <AnimateOnScroll>
              <h2 className="mb-10 font-heading font-semibold tracking-tight text-white sm:text-4xl text-3xl">
        ...
        <section className="relative py-20 sm:py-24 lg:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <AnimateOnScroll>
              <div className="glass-card relative overflow-hidden rounded-2xl p-8 sm:p-12 lg:p-16">
                <div className="relative">
                  ...
                  <div className="mt-8 flex flex-col items-start justify-start gap-3 sm:flex-row">
                    <Button size="lg" className="px-8 bg-white text-black hover:bg-white/80">
                      Start your free trial
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                    <Button size="lg" variant="outline" className="px-8 border-white/30 text-white hover:bg-white hover:text-black">
                      Talk to sales
                    </Button>
                  </div>
                </div>
